-- Convert PO delivery quantities (purchase units) to stock units for material inventory.
-- PO lines use the purchase unit; raw_materials.current_stock is tracked in the stock unit.
...
BEGIN
  ...
  -- PO lines are normally in purchase units; only skip conversion when the line is explicitly in stock units.
