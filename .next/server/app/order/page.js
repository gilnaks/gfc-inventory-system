(()=>{var e={};e.id=778,e.ids=[778],e.modules={5403:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external")},4749:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external")},399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},5528:e=>{"use strict";e.exports=require("next/dist\\client\\components\\action-async-storage.external.js")},1877:e=>{"use strict";e.exports=require("next/dist\\client\\components\\request-async-storage.external.js")},5319:e=>{"use strict";e.exports=require("next/dist\\client\\components\\static-generation-async-storage.external.js")},4300:e=>{"use strict";e.exports=require("buffer")},6113:e=>{"use strict";e.exports=require("crypto")},2361:e=>{"use strict";e.exports=require("events")},3685:e=>{"use strict";e.exports=require("http")},5687:e=>{"use strict";e.exports=require("https")},5477:e=>{"use strict";e.exports=require("punycode")},2781:e=>{"use strict";e.exports=require("stream")},7310:e=>{"use strict";e.exports=require("url")},3837:e=>{"use strict";e.exports=require("util")},9796:e=>{"use strict";e.exports=require("zlib")},2595:(e,t,s)=>{"use strict";s.r(t),s.d(t,{GlobalError:()=>l.a,__next_app__:()=>x,originalPathname:()=>m,pages:()=>c,routeModule:()=>u,tree:()=>d});var r=s(7096),a=s(6132),i=s(7284),l=s.n(i),n=s(2564),o={};for(let e in n)0>["default","tree","pages","GlobalError","originalPathname","__next_app__","routeModule"].indexOf(e)&&(o[e]=()=>n[e]);s.d(t,o);let d=["",{children:["order",{children:["__PAGE__",{},{page:[()=>Promise.resolve().then(s.bind(s,4130)),"C:\\Users\\John\\Desktop\\gfc\\inventory-system\\app\\order\\page.tsx"]}]},{}]},{layout:[()=>Promise.resolve().then(s.bind(s,5345)),"C:\\Users\\John\\Desktop\\gfc\\inventory-system\\app\\layout.tsx"],"not-found":[()=>Promise.resolve().then(s.t.bind(s,9291,23)),"next/dist/client/components/not-found-error"]}],c=["C:\\Users\\John\\Desktop\\gfc\\inventory-system\\app\\order\\page.tsx"],m="/order/page",x={require:s,loadChunk:()=>Promise.resolve()},u=new r.AppPageRouteModule({definition:{kind:a.x.APP_PAGE,page:"/order/page",pathname:"/order",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:d}})},7983:(e,t,s)=>{Promise.resolve().then(s.bind(s,8448))},8448:(e,t,s)=>{"use strict";s.r(t),s.d(t,{default:()=>OrderPage});var r=s(784),a=s(9885),i=s(9708),l=s(7094),n=s(1264),o=s(9697),d=s(1210),c=s(9546),m=s(92),x=s(5808),u=s(5894),p=s(2385),g=s(8375),h=s(6206),b=s(4155),y=s(7820);function OrderPage(){let[e,t]=(0,a.useState)(!1),[s,f]=(0,a.useState)(""),[v,j]=(0,a.useState)(null),[w,N]=(0,a.useState)([]),[_,k]=(0,a.useState)([]),[S,P]=(0,a.useState)(null),[D,q]=(0,a.useState)([]),[C,$]=(0,a.useState)("home"),[F,O]=(0,a.useState)(!1),[L,T]=(0,a.useState)(!0),[z,A]=(0,a.useState)(""),[I,E]=(0,a.useState)(""),[H,Z]=(0,a.useState)(!1),[M,U]=(0,a.useState)(!1),[R,B]=(0,a.useState)(!1),[Y,G]=(0,a.useState)(null),[Q,V]=(0,a.useState)("delivery");(0,a.useEffect)(()=>{let initializeApp=async()=>{T(!0);let e=localStorage.getItem("order_authenticated"),s=localStorage.getItem("order_location");if("true"===e&&s)try{let e=JSON.parse(s);j(e),t(!0),await Promise.all([checkPendingOrders(e.id),fetchPastOrders(e.id),fetchProducts(e.brand_id)])}catch(e){console.error("Error parsing saved data:",e),clearSession()}setTimeout(()=>{T(!1)},800)};initializeApp()},[]),(0,a.useEffect)(()=>{if(!v)return;let e=i.O.channel("order-updates").on("postgres_changes",{event:"*",schema:"public",table:"customer_orders",filter:`location_id=eq.${v.id}`},e=>{console.log("Order update received:",e),("UPDATE"===e.eventType||"INSERT"===e.eventType||"DELETE"===e.eventType)&&(checkPendingOrders(v.id),fetchPastOrders(v.id))}).subscribe();return()=>{i.O.removeChannel(e)}},[v]),(0,a.useEffect)(()=>{S&&"products"===C&&$("home")},[S,C]),(0,a.useEffect)(()=>{if(!v?.brand_id)return;let e=i.O.channel("order-products-changes").on("postgres_changes",{event:"*",schema:"public",table:"products",filter:`brand_id=eq.${v.brand_id}`},()=>{F||fetchProducts(v.brand_id)}).subscribe();return()=>{i.O.removeChannel(e)}},[v?.brand_id,F]);let W=(e=>{if(!e?.brand)return"blue";switch(e.brand.slug){case"mychoice":return"green";case"gelatofilipino":return"red";case"mang-sorbetes":return"yellow";default:return"blue"}})(v),clearSession=()=>{t(!1),j(null),N([]),k([]),P(null),$("home"),A(""),E(""),T(!1),localStorage.removeItem("order_authenticated"),localStorage.removeItem("order_location"),localStorage.removeItem("order_cart_draft")},handleLocationAuth=async e=>{e.preventDefault(),O(!0),A("");try{let{data:e,error:r}=await i.O.from("locations").select("*, brand:brands(*)").eq("passkey",s).single();if(r)throw r;j(e),t(!0),localStorage.setItem("order_authenticated","true"),localStorage.setItem("order_location",JSON.stringify(e)),await Promise.all([checkPendingOrders(e.id),fetchPastOrders(e.id),fetchProducts(e.brand_id)])}catch(e){A("Invalid location passcode. Please try again."),f("")}finally{O(!1)}},fetchProducts=async e=>{try{let{data:t,error:s}=await i.O.from("inventory_summary").select("*").eq("brand_id",e).order("category, product_name");if(s)throw s;N(t||[])}catch(e){console.error("Error fetching products:",e)}},checkPendingOrders=async e=>{try{let{data:t,error:s}=await i.O.from("customer_orders").select(`
          id, status, created_at, total_amount, delivery_type, deposit_slip_url,
          order_details (
            id, product_id, quantity, unit_price,
            products (id, name, price, unit, category)
          )
        `).eq("location_id",e).in("status",["pending","approved","released","paid"]).order("created_at",{ascending:!1}).limit(1);if(s)throw s;t&&t.length>0?P(t[0]):P(null)}catch(e){console.error("Error checking pending orders:",e)}},fetchPastOrders=async e=>{try{let{data:t,error:s}=await i.O.from("customer_orders").select(`
          id, status, created_at, total_amount, delivery_type, deposit_slip_url,
          order_details (
            id, product_id, quantity, unit_price,
            products (id, name, price, unit, category)
          )
        `).eq("location_id",e).in("status",["released","paid","complete","cancelled"]).order("created_at",{ascending:!1});if(s)throw s;q(t||[])}catch(e){console.error("Error fetching past orders:",e)}},getAvailableStock=e=>e.available_stock||0,getCartItemAvailableStock=e=>{let t=w.find(t=>(t.product_id||t.id)===e.product_id);if(t){if("modify"===C&&S){let s=S.order_details?.find(t=>t.product_id===e.product_id);if(s)return(t.available_stock||0)+s.quantity}return t.available_stock||0}return getAvailableStock(e.product)},addToCart=e=>{let t=e.product_id||e.id,s=_.find(e=>e.product_id===t);s?k(e=>e.map(e=>e.product_id===t?{...e,quantity:e.quantity+1}:e)):k(s=>[...s,{product_id:t,quantity:1,product:e}])},updateCartQuantity=(e,t)=>{t<=0?k(t=>t.filter(t=>t.product_id!==e)):k(s=>s.map(s=>s.product_id===e?{...s,quantity:t}:s))},removeFromCart=e=>{k(t=>t.filter(t=>t.product_id!==e))},calculateTotal=()=>{let e=_.reduce((e,t)=>e+(t.product.price||0)*t.quantity,0);return"delivery"===Q?e>=1e4?e:e+500:e>=1e4?.95*e:e},calculateSubtotal=()=>_.reduce((e,t)=>e+(t.product.price||0)*t.quantity,0),calculateItemCount=()=>_.reduce((e,t)=>e+t.quantity,0),getProductsByCategory=()=>{let e=w.reduce((e,t)=>{let s=t.category||"Other";return e[s]||(e[s]=[]),e[s].push(t),e},{});return e},validateStockAvailability=async()=>{let e=[];if(v?.brand_id)try{let{data:t,error:s}=await i.O.from("inventory_summary").select("*").eq("brand_id",v.brand_id);if(s)throw s;N(t||[]);let r=_.map(e=>{let s=t?.find(t=>(t.product_id||t.id)===e.product_id);return s?{...e,product:s}:e});for(let s of(k(r),r)){let r=t?.find(e=>(e.product_id||e.id)===s.product_id);if(r){let t=r.available_stock||0;if("modify"===C&&S){let e=S.order_details?.find(e=>e.product_id===s.product_id);e&&(t+=e.quantity)}s.quantity>t&&e.push(`${r.product_name||r.name}: Requested ${s.quantity}, Available ${t}`)}}}catch(t){for(let s of(console.error("Error fetching fresh product data:",t),_)){let t=getCartItemAvailableStock(s);s.quantity>t&&e.push(`${s.product.product_name||s.product.name}: Requested ${s.quantity}, Available ${t}`)}}return e},handleSubmitOrder=async()=>{if(!v||0===_.length){A("Please add items to your order.");return}let e=await validateStockAvailability();if(e.length>0){A(`Insufficient stock for the following items:
${e.join("\n")}`);return}O(!0),A("");try{for(let e of _){let{error:t}=await i.O.from("products").update({reserved:(e.product.reserved||0)+e.quantity,updated_at:new Date().toISOString()}).eq("id",e.product_id);if(t)throw t}let e=calculateTotal(),{data:t,error:s}=await i.O.from("customer_orders").insert([{location_id:v.id,brand_id:v.brand_id,customer_name:`${v.name} Order`,status:"pending",total_amount:e,delivery_type:Q}]).select();if(s)throw s;let r=_.map(e=>({order_id:t[0].id,product_id:e.product_id,quantity:e.quantity,unit_price:e.product.price||0})),{error:a}=await i.O.from("order_details").insert(r);if(a)throw a;E("Order submitted successfully!"),k([]),await checkPendingOrders(v.id),$("home"),U(!1)}catch(e){console.error("Error submitting order:",e),A("Failed to submit order. Please try again.")}finally{O(!1)}},handleUpdateOrder=async()=>{if(!S||0===_.length)return;let e=await validateStockAvailability();if(e.length>0){A(`Insufficient stock for the following items:
${e.join("\n")}`);return}O(!0),A("");try{if(S.order_details)for(let e of S.order_details){let{error:t}=await i.O.from("products").update({reserved:(e.products.reserved||0)-e.quantity,updated_at:new Date().toISOString()}).eq("id",e.product_id);if(t)throw t}for(let e of(await i.O.from("order_details").delete().eq("order_id",S.id),_)){let{error:t}=await i.O.from("products").update({reserved:(e.product.reserved||0)+e.quantity,updated_at:new Date().toISOString()}).eq("id",e.product_id);if(t)throw t}let e=_.map(e=>({order_id:S.id,product_id:e.product_id,quantity:e.quantity,unit_price:e.product.price||0}));await i.O.from("order_details").insert(e);let t=calculateTotal();await i.O.from("customer_orders").update({total_amount:t,delivery_type:Q}).eq("id",S.id),E("Order updated successfully!"),k([]),await checkPendingOrders(v.id),$("home"),U(!1)}catch(e){console.error("Error updating order:",e),A("Failed to update order. Please try again.")}finally{O(!1)}},handlePhotoUpload=async(e,t)=>{B(!0),G(e);try{let s=t.name.split(".").pop(),r=`${e}_${Date.now()}.${s}`,{data:a,error:l}=await i.O.storage.from("deposit-slips").upload(r,t);if(l)throw l;let{data:{publicUrl:n}}=i.O.storage.from("deposit-slips").getPublicUrl(r),{error:o}=await i.O.from("customer_orders").update({deposit_slip_url:n,status:"paid",updated_at:new Date().toISOString()}).eq("id",e);if(o)throw o;E("Deposit slip uploaded successfully! Order status updated to Paid."),v&&await Promise.all([checkPendingOrders(v.id),fetchPastOrders(v.id)])}catch(e){console.error("Error uploading photo:",e),A("Failed to upload deposit slip. Please try again.")}finally{B(!1),G(null)}},printReceipt=e=>{let t=window.open("","_blank");t&&(t.document.write(`
        <!DOCTYPE html>
        <html>
        <head>
