...
import { Package, ShoppingCart, ArrowRight, FileText } from 'lucide-react'
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-lg shadow-md border p-8 hover:shadow-lg transition-shadow">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">DSIR Reports</h2>
            <p className="text-gray-600 mb-6">
              Daily Sales & Inventory Reports for staff
            </p>
            <button
              onClick={() => router.push('/dsir')}
